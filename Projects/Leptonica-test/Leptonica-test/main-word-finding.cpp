...
int main_word_finding(int    argc,
	char **argv)
{
	...
	NUMAA       *naa;
	SARRAY      *safiles;
	PIX         *pixs, *pixt, *pixt1, *pixt2, *pixd;
	PIXCMAP     *cmap;
	...
	dirin = "C:\\Users\\peter\\OneDrive\\Dokumenti\\Projects\\OCR\\c\\Leptonica-test\\Leptonica-test\\pages";// argv[1];
	rootname = "result_";// argv[2];
